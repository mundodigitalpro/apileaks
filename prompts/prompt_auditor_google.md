...
# Contexto
Disponemos de un archivo de reporte de fugas en la carpeta `data/` que contiene metadatos sobre posibles credenciales expuestas en repositorios públicos. Necesitamos identificar específicamente las claves completas de **Google** para proceder a su revocación.

# Tu Tarea
Tu objetivo es leer el archivo de leaks, filtrar los casos de Google, acceder a los archivos fuente originales y extraer las API Keys completas que han sido expuestas.
